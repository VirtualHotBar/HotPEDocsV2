import{_ as a,o as i,c as n,am as p}from"./chunks/framework.DLqCyLYu.js";const c=JSON.parse('{"title":"系统集成模块功能","description":"","frontmatter":{},"headers":[],"relativePath":"devdoc/shifthpm.md","filePath":"devdoc/shifthpm.md","lastUpdated":1771161427000}'),l={name:"devdoc/shifthpm.md"};function t(h,s,e,k,r,d){return i(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="系统集成模块功能" tabindex="-1">系统集成模块功能 <a class="header-anchor" href="#系统集成模块功能" aria-label="Permalink to “系统集成模块功能”">​</a></h1><blockquote><p>本章节将实现把模块功能加入到你的系统，从而实现模块加载功能</p></blockquote><h2 id="新版hpm加载器实现-推荐" tabindex="-1">新版HPM加载器实现(推荐) <a class="header-anchor" href="#新版hpm加载器实现-推荐" aria-label="Permalink to “新版HPM加载器实现(推荐)”">​</a></h2><p>仓库地址：<a href="https://github.com/VirtualHotBar/HPM-cli/" target="_blank" rel="noreferrer">https://github.com/VirtualHotBar/HPM-cli/</a></p><p>HPM-cli 为命令行工具，无图形界面，请参考以下命令行参数帮助实现 HPM 相关功能：</p><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>HPM(HotPE Module) Manager</span></span>
